...
class PasswordValidator {
  ...
  String? validateChange(String oldPW, String newPW, String newPasswordRepeat) {
    if (newPW.isEmpty || oldPW.isEmpty || newPasswordRepeat.isEmpty) {
      //all password fields must have an input
      return StaticStrings.bothPasswordEmpty;
    }
    if (oldPW == newPW) {
      //new password must not be the same as the old one (rule 5)
