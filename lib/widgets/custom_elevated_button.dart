...
class CustomElevatedButton extends StatelessWidget {
  ...
  /// Constructor
  /// onPressed: Anonymous function triggering an event when button is pressed
  /// text: String showing as button text (Use constants from this Class for best practice)
